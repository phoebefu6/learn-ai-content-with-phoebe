...
(function () {
  ...
  if (crumb && mastheadWrap) {
    ...
    var m = mx || crumb.textContent.match(/Creator session (\d+) of 10/);
    if (m) {
      var current = parseInt(m[1], 10);
      var pages = mx
        ? ["a1-ai-first-content.html", "a2-content-use-case-risk-map.html",
           "a3-brand-voice-anti-slop.html", "a4-ip-disclosure-governance.html",
           "a5-content-ops-roi.html", "a6-content-strategy-future.html"]
        : ["b1-ai-foundations-creators.html", "b2-idea-and-brief.html", "b3-one-idea-many-formats.html",
           "b4-long-form-writing.html", "b5-short-form-social.html",
           "b6-visual-content.html", "b7-video-audio.html",
           "b8-content-pipeline.html", "b9-quality-anti-slop.html", "b10-governance-ip-publishing.html"];
